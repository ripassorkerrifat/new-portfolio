...
const AboutMe = () => {
    return (
        <section
            id="about"
            className="py-20 bg-gradient-to-br from-[var(--primary-bg)] via-[var(--secondary-bg)] to-[var(--primary-bg)] relative overflow-hidden">
            {/* Background Elements */}
            <div className="absolute inset-0 bg-gradient-to-br from-[var(--primary-color)]/5 via-transparent to-[var(--secondary-color)]/5"></div>
            <div className="absolute top-20 left-10 w-72 h-72 bg-[var(--primary-color)]/10 rounded-full blur-3xl"></div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        ...
                        <div
                            ...
                            <div className="relative">
                                ...
                                <div className="relative bg-gradient-to-br from-[var(--card-bg)] to-[var(--card-bg)]/80 backdrop-blur-xl rounded-3xl p-8 border border-[var(--border-color)] shadow-2xl">
                                    <div className="relative">
                                        <Image
