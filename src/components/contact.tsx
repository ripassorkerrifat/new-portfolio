    ...
    return (
        <section
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-8 mb-10 sm:mb-20 lg:mb-24">
                    {contactMethods.map((method, index) => (
                        <div
                            ...
                            <div className="relative text-center">
                                ...
                                <div
                                    className={` lg:size-20 md:size-16 size-14 mx-auto mb-4 sm:mb-6 bg-gradient-to-br ${method.color} md:rounded-3xl rounded-xl flex items-center justify-center border-2 border-[var(--border-color)]/40 group-hover:border-white/40 transition-all duration-500 group-hover:rotate-12 group-hover:scale-125 shadow-lg group-hover:shadow-2xl`}>
                                ...
                                {/* Enhanced Typography */}
                                <h3
                                    className={`text-base md:text-xl font-bold text-[var(--text-primary)] mb-2 sm:mb-3 group-hover:${method.textColor} transition-colors duration-300`}>
                                    {method.title}
                                </h3>
                                <p className="text-xs sm:text-base lg:text-lg text-[var(--text-primary)] font-bold mb-2 group-hover:text-white transition-colors duration-300">
                                    {method.value}
                                </p>
                                <p className="text-[var(--text-secondary)] text-xs sm:text-base lg:text-lg leading-relaxed group-hover:text-white/90 transition-colors duration-300">
                                    {method.description}
                                </p>

                                {/* Interactive Arrow */}
                                <div className="mt-4 opacity-0 hidden md:block group-hover:opacity-100 transition-opacity duration-300">
                    ...
                    <div className="relative glass rounded-3xl p-3 sm:p-8 lg:p-12 border border-[var(--border-color)]/40 hover:border-[var(--primary-color)]/60 transition-all duration-700 backdrop-blur-xl bg-gradient-to-br from-[var(--primary-bg)]/95 to-[var(--secondary-bg)]/95 hover:shadow-2xl hover:shadow-[var(--primary-color)]/20 group overflow-hidden">
                        ...
                        <div className="text-center mb-8 sm:mb-12 relative z-10">
                            <div className="flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-8 mb-8 sm:mb-10">
                                <div className="relative">
                                    <div className="lg:size-24 size-20 bg-gradient-to-br from-[var(--primary-color)]/20 to-[var(--secondary-color)]/20 rounded-3xl flex items-center justify-center border-2 border-[var(--border-color)]/40 group-hover:border-[var(--primary-color)]/60 transition-all duration-500 group-hover:rotate-6 group-hover:scale-110 shadow-xl">
                                ...
                                <div className="text-center">
                                    <h3 className="text-xl sm:text-3xl font-bold text-[var(--text-primary)] mb-3 sm:mb-4 group-hover:text-[var(--primary-color)] transition-colors duration-300">
                                        Start a Conversation
                                    </h3>
                                    <p className="text-xs sm:text-base lg:text-lg text-[var(--text-secondary)] leading-relaxed">
                            ...
                            <div className="grid grid-cols-3 gap-4 sm:gap-6 lg:gap-8 max-w-xl sm:max-w-2xl mx-auto">
                                <div className="text-center">
                                    <div className="text-sm sm:text-xl lg:text-2xl font-bold text-[var(--primary-color)] mb-1 sm:mb-2">
                                        24h
                                    </div>
                                ...
                                <div className="text-center">
                                    <div className="text-sm sm:text-xl lg:text-2xl font-bold text-[var(--secondary-color)] mb-1 sm:mb-2">
                                        100%
                                    </div>
                                    <div className="text-[var(--text-secondary)] text-xs">
                                        Satisfaction
                        ...
                        <div className="mt-8 sm:mt-12 pt-6 sm:pt-8 border-t border-[var(--border-color)]/20">
                            <div className="grid sm:grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 items-center">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <div className="font-bold text-[var(--text-primary)] md:text-lg">
                                            100% Secure
                                        </div>
                                        <div className="text-[var(--text-secondary)] md:text-base text-sm">
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <div className="font-bold text-[var(--text-primary)] md:text-lg text-sm">
                                            Quick Response
                                        </div>
                                        <div className="text-[var(--text-secondary)] md:text-base text-sm">
