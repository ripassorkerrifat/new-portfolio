...
const Achievements = () => {
    ...
    const achievementCategories = [
        { id: 'academic', label: 'Academic', icon: <FaTrophy />, color: 'from-yellow-400 to-orange-500' },
        { id: 'professional', label: 'Professional', icon: <FaAward />, color: 'from-blue-400 to-purple-500' },
        { id: 'technical', label: 'Technical', icon: <FaGem />, color: 'from-green-400 to-teal-500' },
        { id: 'leadership', label: 'Leadership', icon: <FaCrown />, color: 'from-purple-400 to-pink-500' }
    ];
    ...
    const achievements = {
        academic: [
            {
                ...
                description: "Achieved Dean's List for 3 consecutive semesters with outstanding academic performance",
                year: "2020-2021",
                icon: <FaTrophy />,
                level: "Gold",
            ...
            },
            {
                ...
                description: "Recognized for innovative web application project using React and Node.js",
                year: "2022",
                icon: <FaAward />,
                level: "Platinum",
                stats: "1st Place"
            },
            {
                ...
                description: "Won university-level programming competition with algorithmic problem solving",
                year: "2021",
                icon: <FaMedal />,
                level: "Gold",
            ...
            },
            {
                ...
                description: "Awarded merit-based scholarship for exceptional HSC results",
                year: "2018",
                icon: <FaStar />,
                level: "Diamond",
                stats: "GPA 5.00/5.00"
        ...
        professional: [
            ...
            },
            {
                ...
                description: "Achieved Google Cloud Professional Developer certification",
                year: "2023",
                icon: <FaGem />,
                level: "Professional",
                stats: "Cloud Expert"
            },
            {
                ...
                description: "Advanced React certification from Meta (Facebook)",
                year: "2022",
                icon: <FaTrophy />,
                level: "Advanced",
            ...
            },
            {
                ...
                description: "Professional certification in Node.js development",
                year: "2022",
                icon: <FaMedal />,
                level: "Professional",
        ...
        technical: [
            ...
            },
            {
                ...
                description: "Mastered containerization, CI/CD, and cloud deployment",
                year: "2023",
                icon: <FaTrophy />,
                level: "Specialist",
                stats: "Docker & K8s"
            },
            {
                ...
                description: "Specialized in web performance and optimization techniques",
                year: "2022",
                icon: <FaAward />,
                level: "Expert",
                stats: "90+ PageSpeed"
        ...
        leadership: [
            {
                ...
                description: "Led development team of 5+ developers on multiple projects",
                year: "2022-2023",
                icon: <FaCrown />,
                level: "Leader",
            ...
            },
            {
                ...
                description: "Mentored junior developers and conducted technical workshops",
                year: "2021-2023",
                icon: <FaStar />,
                level: "Mentor",
                stats: "20+ Mentees"
            },
            {
                ...
                description: "Successfully managed multiple client projects from inception to delivery",
                year: "2022",
                icon: <FaAward />,
                level: "Manager",
            ...
            },
            {
                ...
                description: "Built and grew local developer community with regular meetups",
                year: "2021-2023",
                icon: <FaGem />,
                level: "Builder",
                stats: "200+ Members"
    ...
    const getLevelColor = (level: string) => {
        switch (level.toLowerCase()) {
            ...
            case 'specialist': return 'from-green-400 to-teal-500';
            case 'advanced': return 'from-orange-400 to-red-500';
            case 'leader': return 'from-purple-500 to-indigo-600';
            case 'mentor': return 'from-teal-400 to-cyan-500';
            case 'manager': return 'from-indigo-400 to-purple-500';
            case 'builder': return 'from-pink-400 to-rose-500';
            case 'contributor': return 'from-emerald-400 to-green-500';
            default: return 'from-gray-400 to-gray-600';
        }
    };

    return (
        <section id="achievements" className="py-20 bg-gradient-to-br from-[var(--primary-bg)] via-[var(--secondary-bg)] to-[var(--accent-bg)] relative overflow-hidden">
            {/* Background Elements */}
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="text-center mb-16">
                    ...
                    <p className="text-[var(--text-secondary)] text-lg md:text-xl max-w-3xl mx-auto leading-relaxed animate-slide-up" style={{animationDelay: "0.2s"}}>
                        Milestones and recognitions that mark my journey of continuous growth and excellence in technology and leadership.
                    </p>
                </div>
                ...
                <div className="flex flex-wrap justify-center gap-4 mb-16">
                    {achievementCategories.map((category, index) => (
                        ...
                        >
                            <span className={`text-2xl transition-transform duration-300 ${activeCategory === category.id ? 'scale-110' : 'group-hover:scale-110'}`}>
                                {category.icon}
                            </span>
                        ...
                        >
                            ...
                            <div className="flex items-start justify-between mb-6">
                                <div className="flex items-center gap-4">
                                    <div className={`w-16 h-16 bg-gradient-to-br ${getLevelColor(achievement.level)} rounded-2xl flex items-center justify-center text-white shadow-lg group-hover:scale-110 transition-transform duration-300`}>
                                        <span className="text-2xl">{achievement.icon}</span>
                                    </div>
                                    <div>
                                        <div className={`inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-bold bg-gradient-to-r ${getLevelColor(achievement.level)} text-white mb-2`}>
                                            <FaStar className="text-xs" />
                                            {achievement.level}
                                        </div>
                                        <p className="text-[var(--text-secondary)] text-sm">{achievement.year}</p>
                                    </div>
                                </div>
                                <div className="text-right">
                                    <div className="glass px-3 py-2 rounded-xl border border-[var(--border-color)]/30">
                                        <p className="text-[var(--primary-color)] font-bold text-sm">{achievement.stats}</p>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="mt-20 max-w-4xl mx-auto">
                    <div className="glass rounded-3xl p-12 border border-[var(--border-color)]/40 hover:border-[var(--primary-color)]/60 transition-all duration-500 backdrop-blur-xl text-center">
                        <h3 className="text-3xl font-bold text-[var(--text-primary)] mb-8">Achievement Summary</h3>
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                            <div className="group">
                                ...
                                <div className="text-3xl font-bold bg-gradient-to-r from-yellow-400 to-orange-500 bg-clip-text text-transparent mb-2">16+</div>
                                <div className="text-[var(--text-secondary)]">Total Awards</div>
                            </div>
                            <div className="group">
                                ...
                                <div className="text-3xl font-bold bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent mb-2">10+</div>
                                <div className="text-[var(--text-secondary)]">Certifications</div>
                            </div>
                            <div className="group">
                                ...
                                <div className="text-3xl font-bold bg-gradient-to-r from-green-400 to-teal-500 bg-clip-text text-transparent mb-2">5+</div>
                            ...
                            <div className="group">
                                ...
                                <div className="text-3xl font-bold bg-gradient-to-r from-purple-400 to-pink-500 bg-clip-text text-transparent mb-2">20+</div>
                                <div className="text-[var(--text-secondary)]">Projects Led</div>
                            </div>
                        </div>
                    </div>
                </div>
